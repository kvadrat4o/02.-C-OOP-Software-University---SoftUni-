...
namespace BashSoft
{
    ...
    {
        public const string ExampleExceptionMessage = "Example";
        ...
        public const string ComparisonOfFilesWithDifferentSizes = "Files not of not equal size, certain mismatch.";
        ...
        public const string InvalidTakeCommand = "Expected command - take";
